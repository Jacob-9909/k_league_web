      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {selectedTeam && teamData[selectedTeam] && (
          <div className="bg-white p-6 rounded-lg shadow-md">
            <h2 className="text-xl font-semibold mb-4">{selectedTeam} 전략 개요</h2>
            <div>
              <p><strong>주 포메이션:</strong> {teamData[selectedTeam]?.formation}</p>
              <p><strong>점유율:</strong> {(teamData[selectedTeam]?.possessionRate / teamData[selectedTeam]?.matchCount).toFixed(2)}%</p>
              <p><strong>패스 정확도:</strong> {(teamData[selectedTeam]?.passAccuracy / teamData[selectedTeam]?.matchCount).toFixed(2)}%</p>
              <p><strong>경기당 슈팅:</strong> {(teamData[selectedTeam]?.shotsPerGame / teamData[selectedTeam]?.matchCount).toFixed(2)}</p>
              <p><strong>경기당 태클:</strong> {(teamData[selectedTeam]?.tacklesPerGame / teamData[selectedTeam]?.matchCount).toFixed(2)}</p>
              <p><strong>득점:</strong> {teamData[selectedTeam]?.goalsScored}</p>
              <p><strong>실점:</strong> {teamData[selectedTeam]?.goalsConceded}</p>
            </div>
          </div>
        )}
        ...
        {selectedTeam && (
          <div className="bg-white p-6 rounded-lg shadow-md">
            <h2 className="text-xl font-semibold mb-4">{selectedTeam} 전략 분석</h2>
            <div>
        ...
        {selectedTeam && teamData[selectedTeam] && (
          <div className="bg-white p-6 rounded-lg shadow-md md:col-span-2">
            <h2 className="text-xl font-semibold mb-4">{selectedTeam} 전략 분석 리포트</h2>
            <div>
              <p>
