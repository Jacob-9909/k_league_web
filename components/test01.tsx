...
export default function HomePage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      ...
      <main className="flex-3 pt-6">
  <section className="w-full py-12 md:py-24 lg:py-32 xl:py-48">
    <div className="container px-6 md:px-6">
      <div className="flex flex-col items-center space-y-6 text-center">
        <div className="space-y-9">
          <h1 className="text-xl font-bold tracking-snug sm:text-xl md:text-2xl lg:text-7xl leading-snug bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-purple-600">
            K리그 승률예측 프로젝트
                </h1>
